...
cd whiteplanes-0.0.1
# rm -r whiteplanes.egg-info PKG-INFO setup.cfg

git init
git add src test setup.py

GIT_AUTHOR_NAME='Takuya Katsurada' \
GIT_COMMITTER_NAME='Takuya Katsurada' \
GIT_AUTHOR_EMAIL='mail@nutcrack.io' \
GIT_COMMITTER_EMAIL='mail@nutcrack.io' \
GIT_AUTHOR_DATE='2016-05-14 13:54:09 +0000 UTC' \
GIT_COMMITTER_DATE='2016-05-14 13:54:09 +0000 UTC' \
