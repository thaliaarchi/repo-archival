...
# and two archives with Mercurial history and untracked binaries. The quotes
# below come from this page.
...
#
# > Vita Nuova's modified copy of `BETA.2 Build 16' from Lucent's Inferno Business Unit
# > includes source
# > the tree was received in 1996 but this snapshot includes changes made by VN and others into 1997

# https://github.com/inferno-os/inferno-2e (identical mirror)
# https://bitbucket.org/inferno-os/inferno-2e/
#
# > Inferno Second Edition: last distribution (Release 2.3, ca. July 1999) from Lucent's Inferno Business Unit, including source
# > no manual pages?? exactly.
# > the documents are not included; they were in Framemaker format on Nt or Solaris
...
# Inferno Fourth Edition 20150328 snapshot:
#
# > Unix-like systems
...
# > instructions in the file INSTALL. It tells how to change mkconfig and set
# > your path or PATH to the right bin directory before you can remake the tree
# > using mk.
#
...
#
# Current Inferno development
#
# The Bitbucket repo used to be the main source, but development seems to now
# have switched to GitHub. The last common commit was on 2021-10-11 and any
# commits after that on Bitbucket are cherry-picked from GitHub.
