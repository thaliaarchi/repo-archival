...
wget -q https://web.archive.org/web/20030423000132id_/http://compsoc.dur.ac.uk:80/whitespace/whitespace.pl
...
git commit -q -m 'Contribute Whitespace interpreter in Perl

https://web.archive.org/web/20030423000132/http://compsoc.dur.ac.uk:80/whitespace/whitespace.pl'

wget -q https://raw.githubusercontent.com/hostilefork/whitespacers/1ae82eb716c65346a71aebf9f92d96872463f220/perl/whitespace.pl -O whitespace.pl
git add whitespace.pl
...
git commit -q -m 'Update perl to whitespace 0.3
