...
wget https://web.archive.org/web/20060506022832id_/http://www.burghard.info:80/homepagenew/code/whitespace/wsa.zip
unzip wsa.zip
mv wsa burghard-wsa
cd burghard-wsa
git init -q
...
cd ..
wget https://web.archive.org/web/20060506022719id_/http://www.burghard.info:80/homepagenew/code/whitespace/wsintercpp.zip
unzip wsintercpp.zip
...
cd ..
wget https://web.archive.org/web/20060428020415id_/http://www.burghard.info:80/homepagenew/code/whitespace/wsinterws.zip
unzip wsinterws
